...
export function DiagnosticsPanel({ project, acknowledged, collapsed, onAcknowledge, onFocus, onToggle }: { project: StudioProject; acknowledged: Set<string>; collapsed: boolean; onAcknowledge: (key: string) => void; onFocus: (id: string) => void; onToggle: () => void }) {
